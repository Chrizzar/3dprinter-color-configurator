function main() {
    ...
    const MODEL_PATH = "models/legacy/voron_legacy_8accents.glb";
    ...
    const PTFECOUPLER_MTL = new THREE.MeshPhongMaterial({ 
        color: 0x5887e3, 
        shininess: 150,
    });
    ...
    { childID: "3_third_color", mtl: INITIAL_MTL },
    { childID: "4_fourth_color", mtl: INITIAL_MTL },
    { childID: "5_toolhead_parts", mtl: INITIAL_MTL },
    { childID: "6_electronics", mtl: INITIAL_MTL },
    { childID: "7_screen_back", mtl: INITIAL_MTL },
    { childID: "8_frame", mtl: FRAME_MTL },
    { childID: "bed_bottom", mtl: SILVER_MTL },
    { childID: "bed_heating", mtl: DARKSILVER_MTL },
    ...
    { childID: "ptfe_coupler", mtl: PTFECOUPLER_MTL },
    ...
    { childID: "white", mtl: PEARLWHITE_MTL },
    ];
    ...
    controls.target.set(0, -0.475, 0); // Model offset (focus at height)
    ...
    // Select Option
    const options = document.querySelectorAll(".optionLegacy_8accents");
