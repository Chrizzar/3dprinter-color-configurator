function main() {
    ...
    const MODEL_PATH = "models/switchwire/voron_switchwire_8accents.glb";
    ...
    { childID: "3_toolhead_parts", mtl: INITIAL_MTL },
    { childID: "4_corners_parts1", mtl: INITIAL_MTL },
    { childID: "5_corners_parts2", mtl: INITIAL_MTL },
    { childID: "6_chains", mtl: INITIAL_MTL },
    { childID: "7_skirt_color_change", mtl: INITIAL_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionSwitchwire_8accents");
