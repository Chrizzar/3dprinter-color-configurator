function main() {
    ...
    const MODEL_PATH = "models/v2/voron_v2_7accents.glb";
    ...
    { childID: "4_chains", mtl: INITIAL_MTL },
    { childID: "5_exhaust", mtl: INITIAL_MTL },
    { childID: "6_exhaust_filter", mtl: INITIAL_MTL },
    { childID: "7_frame", mtl: FRAME_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionV2_7accents");
