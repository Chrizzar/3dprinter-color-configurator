function main() {
    ...
    const MODEL_PATH = "models/v0/voron_v0_8accents.glb";
    ...
    { childID: "3_stops", mtl: INITIAL_MTL },
    { childID: "4_skirt1", mtl: INITIAL_MTL },
    { childID: "5_skirt2", mtl: INITIAL_MTL },
    { childID: "6_hotend_extruder_part1", mtl: INITIAL_MTL },
    { childID: "7_hotend_extruder_part2", mtl: INITIAL_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionV0_8accents");
