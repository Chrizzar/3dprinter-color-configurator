function main() {
    ...
    const MODEL_PATH = "models/v2/voron_v2_8accents.glb";
    ...
    { childID: "4_corners_parts", mtl: INITIAL_MTL },
    { childID: "5_toolhead_parts", mtl: INITIAL_MTL },
    { childID: "6_chains", mtl: INITIAL_MTL },  
    { childID: "7_skirt_accent", mtl: INITIAL_MTL },
    ...
    { childID: "screws", mtl: LIGHT_BLACK_MTL }, // make this in fusion 360
        
    { childID: "silver", mtl: SILVER_MTL },
        
    { childID: "spring_assembly", mtl: SILVER_MTL }, // make this in fusion 360
        
    { childID: "vhb", mtl: BLACK_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionV2_8accents");
