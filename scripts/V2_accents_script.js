function main() {
    ...
    { childID: "third_color", mtl: INITIAL_MTL },
    { childID: "belts", mtl: INITIAL_MTL },
    { childID: "exhaust", mtl: INITIAL_MTL },
    { childID: "exhaust_filter", mtl: INITIAL_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionV2_accents");
