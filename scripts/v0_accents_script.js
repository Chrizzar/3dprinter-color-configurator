function main() {
    ...
    const MODEL_PATH = "models/Voron_V0_9_colors.glb";
    ...
    { childID: "stops", mtl: INITIAL_MTL },
    { childID: "powersupply_shroud", mtl: INITIAL_MTL },
    { childID: "skirt_1", mtl: INITIAL_MTL },
    { childID: "skirt_2", mtl: INITIAL_MTL },
    { childID: "hotend_extruder_part1", mtl: INITIAL_MTL },
    { childID: "hotend_extruder_part2", mtl: INITIAL_MTL },
    ...
    // Select Option
    const options = document.querySelectorAll(".optionV0_accents");
